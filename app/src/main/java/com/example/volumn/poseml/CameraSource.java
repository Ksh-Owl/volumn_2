...
package com.example.volumn.poseml;
...
public class CameraSource {
  ...
  private com.example.volumn.poseml.VisionImageProcessor frameProcessor;
  ...
  public void setMachineLearningFrameProcessor(com.example.volumn.poseml.VisionImageProcessor processor) {
    synchronized (processorLock) {
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
        ...
        try {
          synchronized (processorLock) {
            frameProcessor.processByteBuffer(
                data,
                new com.example.volumn.poseml.FrameMetadata.Builder()
